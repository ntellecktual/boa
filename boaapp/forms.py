...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta(UserCreationForm.Meta):
        ...
        fields = UserCreationForm.Meta.fields + ('email',) # Make sure 'username', 'password', 'password2' are implicitly included or explicitly listed if you override completely.
